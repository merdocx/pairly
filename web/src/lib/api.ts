...
export type WatchlistItem = { movie_id: number; media_type: 'movie' | 'tv'; added_at: string; rating: number | null; watched: boolean; partner_rating?: number | null; title: string; release_date: string | null; poster_path: string | null; genre?: string | null };
