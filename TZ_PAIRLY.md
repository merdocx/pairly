...
| ID | Требование | Приоритет |
|----|------------|-----------|
| MISC-01 | Профиль пользователя: отдельная страница профиля с отображением имени (не обязательно уникальное, редактирование не предусмотрено в MVP) и email (только просмотр) | Must |
...
- **Веб-приложение (React/Next.js):**
  ...
  - Профиль пользователя (просмотр имени и email)  
  - Адаптивный дизайн для мобильных устройств  
...
- **Данные пользователя:** email (уникальный), пароль, имя (не уникальное, редактирование не предусмотрено в MVP).  
